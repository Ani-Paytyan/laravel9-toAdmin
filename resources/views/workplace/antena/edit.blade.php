    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right float-end">
                <a class="btn btn-primary" href="{{ URL::previous(route('antena.index')) }}">{{ trans('page.dashboard.back_button') }}</a>
            </div>
        </div>
    </div>

    <form action="{{ route('workplace.antena.update', [$workplace, $antena]) }}" method="POST">
        @csrf
        @method('PUT')
